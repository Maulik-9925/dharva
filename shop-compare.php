...
<!-- Mirrored from live.themewild.com/fameo/shop-compare.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 08 Mar 2025 06:59:39 GMT -->
                        ...
                        <div class="col-12 col-md-6 col-lg-6 col-xl-5">
                            <div class="header-top-left">
                                <ul class="header-top-list">
                                    <li><a
                                            href="https://live.themewild.com/cdn-cgi/l/email-protection#9bf2f5fdf4dbfee3faf6ebf7feb5f8f4f6"><i
                ...
                <div class="table-responsive">
                    <table class="table table-bordered compare-table">
                        <tbody>
                            ...
                            <tr>
                                <th>Product Name</th>
                                <td><a href="#" class="compare-title">Simple Denim Chair</a></td>
                                <td><a href="#" class="compare-title">Simple Denim Chair</a></td>
                                <td><a href="#" class="compare-title">Simple Denim Chair</a></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th>Action</th>
                                <td><a href="#" class="theme-btn"> <span class="far fa-shopping-bag"></span>Add To
                                        Cart</a></td>
                                <td><a href="#" class="theme-btn"> <span class="far fa-shopping-bag"></span>Add To
                                        Cart</a></td>
                                <td><a href="#" class="theme-btn"> <span class="far fa-shopping-bag"></span>Add To
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="footer-widget-box about-us">
                            ...
                            <ul class="footer-contact">
                                ...
                                <li><a
                                        href="https://live.themewild.com/cdn-cgi/l/email-protection#177e79717857726f767a677b723974787a"><i
