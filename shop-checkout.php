...
<!-- Mirrored from live.themewild.com/fameo/shop-checkout.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 08 Mar 2025 06:59:36 GMT -->
...
<body>
                        ...
                        <div class="col-12 col-md-6 col-lg-6 col-xl-5">
                            <div class="header-top-left">
                                <ul class="header-top-list">
                                    <li><a
                                            href="https://live.themewild.com/cdn-cgi/l/email-protection#f891969e97b89d80999588949dd69b9795"><i
                                                class="far fa-envelopes"></i>
                                            <span class="__cf_email__"
                                                data-cfemail="a7cec9c1c8e7c2dfc6cad7cbc289c4c8ca">[email&#160;protected]</span></a>
                                    </li>
                            ...
                            <div class="shop-checkout-step">
                                <div class="accordion" id="shopCheckout">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-12">
                                                                <button type="button" class="theme-btn theme-btn2"><span
                                                                        class="fas fa-arrow-left"></span>Back To
                                                                    Cart</button>
                                    ...
                                    <div class="accordion-item">
                                        <h2 class="accordion-header">
                                            <button class="accordion-button collapsed" type="button"
                                                ...
                                                aria-expanded="false" aria-controls="checkoutStep2">
                                                ...
                                                <div class="shop-checkout-form">
                                                    <form action="#">
                                                        <div class="row">
                                                                        ...
                                                                        <div class="col-md-6 col-lg-4 col-xxl-3">
                                                                            <div class="form-check">
                                                                                <input class="form-check-input"
                                                                                    type="radio" checked name="method"
                                                                                    id="ssm-1">
                                                                                <label class="form-check-label"
                                                                                    for="ssm-1">
                                                                                    Standard
                                                            ...
                                                            <div class="col-lg-12">
                                                                <button type="button" class="theme-btn theme-btn2"><span
                                                                        class="fas fa-arrow-left"></span>Previous</button>
                                                                <button type="submit" class="theme-btn">Next Step<i
                                                                        class="fas fa-arrow-right"></i></button>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="checkoutStep3" class="accordion-collapse collapse"
                                            data-bs-parent="#shopCheckout">
                                            <div class="accordion-body">
                                                <div class="shop-checkout-payment">
                                                    ...
                                                    <div class="tab-content" id="pills-tabContent">
                                                        <div class="tab-pane fade show active" id="pills-1"
                                                            role="tabpanel" aria-labelledby="pills-tab-1" tabindex="0">
                                                            <div class="shop-checkout-form">
                                                                <form action="#">
                                                                    <div class="row">
                                                                        <div class="col-lg-6">
                                                                        ...
                                                                        <div class="col-lg-6">
                                                                            <button type="button"
                                                                                class="theme-btn theme-btn2"><span
                                                                                    class="fas fa-arrow-left"></span>Previous</button>
                                                                            <button type="submit" class="theme-btn">Pay
                                                                                Now<i
                                                                                    class="fas fa-arrow-right"></i></button>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="shop-checkout-form">
                                                                <form action="#">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-6">
                                                                            <button type="submit"
                                                                                class="theme-btn">Login Account<i
                                                                                    class="fas fa-arrow-right"></i></button>
                                                                        </div>
                                                                    </div>
                                                                </form>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="footer-widget-box about-us">
                            ...
                            <ul class="footer-contact">
                                ...
                                <li><a
                                        href="https://live.themewild.com/cdn-cgi/l/email-protection#a6cfc8c0c9e6c3dec7cbd6cac388c5c9cb"><i
                                            class="far fa-envelope"></i><span class="__cf_email__"
                                            data-cfemail="3b52555d547b5e435a564b575e15585456">[email&#160;protected]</span></a>
                                </li>
    ...
    <script data-cfasync="false"
        src="../cdn-cgi/scripts/email-decode.min.js-cb/cloudflare-static/email-decode.min.php"></script>
...
<!-- Mirrored from live.themewild.com/fameo/shop-checkout.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 08 Mar 2025 06:59:37 GMT -->
