<?php include('header.php'); ?>
    ...
    <main class="main">
        ...
        <div class="site-breadcrumb">
            <div class="site-breadcrumb-bg" style="background: url(assets/img/product/pro-b.jpg)"></div>
            <div class="container">
                <div class="site-breadcrumb-wrap">
                    <h4 class="breadcrumb-title">Decorative Laminates</h4>
                    <ul class="breadcrumb-menu">
                        <li><a href="index.php"><i class="far fa-home"></i> Home</a></li>
                        <li class="active">Decorative Laminates</li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-md-9 col-lg-6 col-xxl-5">
                        <div class="shop-single-gallery">
                            <!-- <a class="shop-single-video popup-youtube"
                                href="https://www.youtube.com/watch?v=ckHzmP1evNU" data-tooltip="tooltip"
                                title="Watch Video">
                            ...
                            <div class="flexslider-thumbnails">
                                <ul class="slides">
                                    <li data-thumb="assets/img/product/01.png" rel="adjustX:10, adjustY:">
                                        <img src="assets/img/product/pro-d.jpg" alt="#">
                                    </li>
                    ...
                    <div class="col-md-12 col-lg-6 col-xxl-6">
                        <div class="shop-single-info">
                            <h4 class="shop-single-title">150 MR - WEB LINES( BLACK)</h4>
                            ...
                            <p class="mb-3 mt-4">
                            It seems like you're referring to "150 MR - WEB LINES (BLACK)," but I'm not entirely sure what this term relates to. Could you clarify the context? Are you referring to a product, design specification, or perhaps something related to a specific industry, like textiles, web design, or another field? Let me know so I can provide a more accurate description!
                            </p>
                            ...
                            <div class="shop-single-sortinfo">
                                <ul>
                                    ...
                                    <li>Tags: <a href="#">Furniture</a>,<a href="#">Chair</a>,<a href="#">Modern</a>,<a
                                            href="#">Shop</a></li>
                                </ul>
                            </div>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-6 col-lg-12 col-xl-6">
                                        <div class="shop-single-btn">
                                            <a href="#" class="theme-btn"><span class=""></span>Download</a>
                    ...
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="tab1" role="tabpanel" aria-labelledby="nav-tab1">
                            <div class="shop-single-desc">
                                <p>
                                "150 MR - WEB LINES (BLACK)" could refer to a black-colored fabric or material with specific web lines or patterns, with "150 MR" potentially indicating a weight or thread count, or a reference to a specific textile finish. It might describe a fabric used in applications such as apparel, upholstery, or industrial applications.
                                </p>
                                <p>
                                In web design, "web lines" could indicate lines used for layout or styling on a webpage. "150 MR" might be a specific reference to the margin, grid size, or a particular design specification. The term "black" would likely refer to the color of the lines.
                                </p>
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-xl-5">
                                        <div class="shop-single-list">
                                            ...
                                            <ul>
                                                ...
                                                <li><span>Available Colors:</span> White/Red/Blue,Black/Orange/Green
                                                </li>
                                        ...
                                        <div class="blog-comments-item mt-0">
                                            ...
                                            <div class="blog-comments-content">
                                                ...
                                                <p>Lorem Ipsum is simply dummy text of the printing and typesetting
                                                    ...
                                                    five centuries but also the leap electronic typesetting, remaining
                                                    essentially unchanged. It was popularised in the with the release of
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="site-heading-inline">
                                    <h2 class="site-title">Related Product</h2>
                        ...
                        <div class="row g-4 item-2">
                            <div class="col-md-6 col-lg-3">
                                <div class="product-item">
                                    ...
                                    <div class="product-content">
                                        <h3 class="product-title"><a href="shop-single.php">150 MR - WEB LINES( BLACK)</a></h3>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="product-item">
                                    ...
                                    <div class="product-content">
                                        <h3 class="product-title"><a href="shop-single.php">164SF-914XL - SONAMA OAK</a></h3>
                                        <!-- <div class="product-rate">
                                            <i class="fas fa-star"></i>
                                            <i class="fas fa-star"></i>
                                            <i class="fas fa-star"></i>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="product-item">
                                    ...
                                    <div class="product-content">
                                        <h3 class="product-title"><a href="shop-single.php">165 - CUT WOOD</a></h3>
                                        <!-- <div class="product-rate">
                                            <i class="fas fa-star"></i>
                                            <i class="fas fa-star"></i>
                                            <i class="fas fa-star"></i>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="product-item">
                                    ...
                                    <div class="product-content">
                                        <h3 class="product-title"><a href="shop-single.php">173 - COPPER WALNUT</a></h3>
                                        <!-- <div class="product-rate">
                                            <i class="fas fa-star"></i>
                                            <i class="fas fa-star"></i>
                                            <i class="fas fa-star"></i>
